...
ibmcloud iam service-id-delete "$SERVICE_ID"`}</code>
    ...
    <section style={sectionStyle}>
      ...
      <p style={paragraphStyle}>
        The import feature recognises worksheets from all four domains: Classic and VPC
        (&quot;v&quot; prefix, e.g., &quot;vVirtualServers&quot;), PowerVS (&quot;p&quot; prefix,
        e.g., &quot;pPvsInstances&quot;), and Platform Services (&quot;s&quot; prefix,
        e.g., &quot;sServiceInstances&quot;). Worksheets with unrecognised names are skipped.
      </p>
      <p style={paragraphStyle}>
